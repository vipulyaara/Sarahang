...
//import com.sarahang.playback.core.*
...
//
//const val DEFAULT_FORWARD = 20 * 1000
//const val DEFAULT_REWIND = 10 * 1000
//
...
//        /* context = */ context,
//        /* tag = */ context.getString(R.string.player_name),
//        /* mbrComponent = */ null,
...
//
//        if (queue == null) {
//            queue = mediaId.toAudioList(audioDataSource).map { it.id }.apply {
//                if (mediaId.index >= 0 && isNotEmpty())
//                    audioId = if (mediaId.index < size) get(mediaId.index) else first()
//            }
//            queueTitle = mediaId.toQueueTitle(audioDataSource).toString()
//        }
//
//        if (queue.isNotEmpty()) {
...
//        playerEventLogger.logEvent(event, mapOf("mediaId" to mediaId))
//    }
//}
